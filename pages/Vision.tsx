                        ...
                        {pillars.map((pillar, index) => (
                            ...
                            >
                                ...
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-11 h-11 rounded-xl bg-gray-50 border border-gray-100 flex items-center justify-center flex-shrink-0 group-hover:bg-orange/5 group-hover:border-orange/20 transition-all duration-300">
                                        <pillar.icon className="w-5 h-5 text-gray-600 group-hover:text-orange transition-colors duration-300" />
                                    </div>
