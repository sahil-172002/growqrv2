...
export const UnifiedShowcase: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    // 1. Expand Enterprise Panel (Black) from 0% circle to 150% circle
    ...
    // 2. Parallax Content Effects
    // Individual fades out and zooms in (flying through it)
    ...
    // Enterprise fades in and scales down (landing)
    ...
    // 1. Expand University Panel (Orange) from 0% circle
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-white z-0">
        <div ref={individualContentRef} className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">

          {/* Visual: THE BIO-IDENTITY ORB */}
          <div className="order-2 md:order-1 flex justify-center perspective-1000">
            <div className="relative w-80 h-80 flex items-center justify-center transform-style-3d animate-float">
          ...
          <div className="order-1 md:order-2 text-center md:text-left">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-gray-50 rounded-full border border-gray-100">
            ...
            <h2 className="text-5xl md:text-7xl font-black text-black mb-6 leading-tight font-montreal">
      ...
      {/* --- PANEL 2: ENTERPRISES (Overlay 1 - Black) --- */}
      <div
        ref={enterprisePanelRef}
        className="absolute inset-0 flex items-center justify-center bg-black z-10"
        style={{ clipPath: 'circle(0% at 50% 50%)' }} // Initial State: Hidden
      >
        <div ref={enterpriseContentRef} className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">

          {/* Content */}
          <div className="text-center md:text-left">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-white/10 rounded-full border border-white/20">
              <span className="w-2 h-2 rounded-full bg-white animate-pulse"></span>
              <span className="text-xs font-bold tracking-widest text-white/80 uppercase">For Enterprises</span>
            </div>
            <h2 className="text-5xl md:text-7xl font-black text-white mb-6 leading-tight font-montreal">
              HIRE SKILLS. <br />
      ...
      {/* --- PANEL 3: UNIVERSITIES (Overlay 2 - Orange) --- */}
      <div
        ref={universityPanelRef}
        className="absolute inset-0 flex items-center justify-center bg-orange z-20"
        style={{ clipPath: 'circle(0% at 50% 50%)' }} // Initial State: Hidden
      >
        <div ref={universityContentRef} className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">

          {/* Visual: THE ASCENSION STACK */}
          <div className="order-2 md:order-1 flex justify-center perspective-1000">
            <div className="relative w-80 h-80 flex items-center justify-center transform-style-3d rotate-x-60 rotate-z-45">

              {/* Base Platform */}
              <div className="absolute w-40 h-40 bg-white/20 rounded-lg shadow-xl translate-z-0 transform rotate-45 backdrop-blur-sm"></div>

              {/* Rising Steps (Matte White Blocks) */}
          ...
          {/* Content */}
          <div className="order-1 md:order-2 text-center md:text-left">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-black/10 rounded-full border border-black/10">
              <span className="w-2 h-2 rounded-full bg-white animate-pulse"></span>
