    ...
    <div ref={containerRef} className="relative h-[100dvh] bg-white text-black overflow-hidden perspective-1000">
            ...
            {[...Array(8)].map((_, i) => (
              <div key={i}
                ...
                style={{
                  top: '50%',
                  left: '50%',
                  transform: `rotate(${i * 45}deg) translate(140px) rotate(-${i * 45}deg) translateZ(${i * 10}px)`,
                }}
              >
      ...
      <div className="relative z-10 container mx-auto px-6 h-full">
        ...
        <div ref={text1Ref} className="absolute inset-0 flex flex-col items-center justify-center text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gray-50 border border-gray-200 mb-6 md:mb-8 animate-fade-in-up">
            <span className="w-2 h-2 rounded-full bg-orange animate-pulse"></span>
            <span className="text-[10px] md:text-xs font-bold tracking-widest text-gray-500 uppercase">System Online</span>
          </div>

          <h1 className="text-5xl md:text-9xl font-black tracking-tighter text-black mb-6 leading-[0.9] font-montreal">
            ONE <span className="text-orange">QR.</span><br />
            INFINITE<br />
            WORLD.
          </h1>

          <p className="text-lg md:text-2xl text-gray-500 max-w-2xl mx-auto font-light leading-relaxed px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 px-4 perspective-1000">
              ...
              <div className="t2-pillar group relative h-64 md:h-80 flex flex-col items-center justify-end pb-8">
                ...
                <div className="t2-artifact t2-artifact-3 absolute top-8 md:top-12 w-24 h-24 md:w-32 md:h-32 transform-style-3d">
                  ...
                  <div className="absolute top-1/2 left-1/2 w-8 h-8 md:w-12 md:h-12 bg-gray-100 rounded-full transform -translate-x-1/2 -translate-y-1/2 opacity-80 backdrop-blur-sm"></div>
                </div>
                <div className="relative z-10 text-center">
                  <div className="text-3xl md:text-4xl font-bold text-black mb-2">Global</div>
